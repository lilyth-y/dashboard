...
// Helper: Signup as test user
async function login(page: Page) {
  // Mock API for dashboard to ensure consistent data regardless of auth state for UI testing
  await page.route('*/**/api/financial/dashboard', async route => {
    const json = {
      summary: { totalIncome: 5000000, totalExpense: 3000000, netProfit: 2000000 },
      expensesByCategory: [],
      recentTransactions: [],
      monthlyStats: [],
      dailyTrends: []
  ...
  const name = `Dashboard User ${timestamp}`;
