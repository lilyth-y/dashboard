...
import { TaskDetailDialog } from "@/components/dashboard/projects/task-detail-dialog"
...
export default function ProjectDetailPage({ params }: { params: { id: string } }) {
  ...
  }, [projectId, filterAssignee, filterPriority, filterFrom, filterTo, selectedDate, router, pathname, searchParams])
